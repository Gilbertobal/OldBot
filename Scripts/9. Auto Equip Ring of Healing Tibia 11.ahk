...
Sleep, 1000
IfNotExist, Images\RoHInSlot_Tibia11.png
   MsgBox, RoHInSlot_Tibia11.png does not exists.
ImageSearch, FoundX, FoundY, A_ScreenWidth - 168, 0, A_ScreenWidth, A_ScreenHeight - A_ScreenHeight + 432, Images\RoHInSlot_Tibia11.png
Sleep, 1000
	 if ErrorLevel = 1
		{
		WinWaitActive, ahk_class Qt5QWindowOwnDCIcon
